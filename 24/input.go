...
type TilingInstruction []Direction

func parseInput(input string) []TilingInstruction {
	lines := strings.Split(input, "\n")
	instructions := []TilingInstruction{}

	for _, l := range lines {
		var tilingInstruction TilingInstruction
		...
		for i := 0; i < len(l); i++ {
			...
			tilingInstruction = append(tilingInstruction, dir)
		}

		instructions = append(instructions, tilingInstruction)
	}

	return instructions
}

var TilesInput = `nenwnwnwnwnewnwsenwnwnwsenwnwsenwnenww
